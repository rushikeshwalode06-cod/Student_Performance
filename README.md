...
4. Helps identify weak students
5. Improves academic decision-making
...
2. Attendance
3. Marks
4. Performance (Target Variable)

## 🧠 Machine Learning Model
Algorithm Used: Logistic  Regression 
![ml](https://github.com/rushikeshwalode06-cod/Student_Performance/blob/main/Student%20Performance%20Graph.png?raw=true)
...
1. Add more features (sleep, activities, etc.)
